...
@lru_cache(maxsize=1)
def get_spacy_model(model_name: str = "en_core_web_sm", model_url: str = "https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.7.0/en_core_web_sm-3.7.0.tar.gz") -> Language:
